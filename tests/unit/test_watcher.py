...
def test_create_event(watcher):
    ...
    obj = {"Key": "images/test.jpg", "Size": 1024, "ETag": '"abc123"', "LastModified": None}
        ...
        "Records": [
            {
                ...
                "s3": {
                    ...
                    "object": {"key": "images/test.jpg", "size": 2048, "eTag": '"def456"'},
                },
            }
        ]
    }
...
def test_parse_event():
    ...
    event = {"bucket": "my-bucket", "key": "images/photo.jpg"}
